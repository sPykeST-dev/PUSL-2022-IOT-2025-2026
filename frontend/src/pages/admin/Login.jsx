    ...
    return (
        <div className="min-h-screen flex" style={{ background: '#f1f5f9' }}>
            ...
            >
                ...
                {/* Status box decoration — UPDATED: side-by-side boxes instead of full-width pills */}
                <div className="flex gap-3">
                    {[
                        ...
                        <div
                            key={l.label}
                            className="flex-1 flex flex-col justify-between px-4 py-4 rounded-xl"
                            style={{ background: 'rgba(255,255,255,0.06)' }}
                        >
                            <span className="text-indigo-200 text-sm font-semibold">{l.label}</span>
                            <span className="flex items-center gap-1.5 text-xs font-semibold text-indigo-300 mt-3">
